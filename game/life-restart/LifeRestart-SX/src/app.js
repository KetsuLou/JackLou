  ...
  initPages() {
    ...
    const specialThanksPage = $(`
        <div id="main">
            ...
            <button class="sponsor" onclick="globalThis.open('https://www.jacklou.cn')" style="background: linear-gradient(90deg,#946ce6,#7e5fd9); left:auto; right:50%; transform: translate(-2rem,-50%);">打赏策划(爱发电)</button>
            <button class="sponsor" onclick="globalThis.open('https://space.bilibili.com/41369736')" style="background-color:#c69; left:50%; right:auto; transform: translate(2rem,-50%);">打赏程序(顿顿饭)</button>
        </div>
        `);
    ...
    const talentPage = $(`
        <div id="main">
            ...
            <button id="random" class="mainbtn" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);"">N连抽！</button>
